...
export default function LoginScreen(props) {
  ...
  const logIn = async () => {
    ...
    try {
      ...
      if (datita.token) {
				console.log(datita);
				console.log(datita.driver);
				console.log(datita.driver.correo);
				console.log(datita.driver.correo,datita.token);
				auth.setUserSession(datita.driver.correo,datita.token);
